            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between">
                  <h6 class="card-title">
                    <i class="mdi mdi-finance menu-icon"></i> Poin Tertinggi
                  </h6>
                </div>
                ...
                <div class="list d-flex align-items-center border-bottom py-3">
                  <div class="wrapper w-100">
                    <p>
                      ...
                      <span class="badge badge-danger">280</span>
                    </p>
                ...
                <div class="list d-flex align-items-center border-bottom py-3">
                  <div class="wrapper w-100">
                    <p>
                      ...
                      <span class="badge badge-danger">260</span>
                    </p>
                ...
                <div class="list d-flex align-items-center pt-3">
                  <div class="wrapper w-100">
                    <p>
                      <b>Ahmad Tom Jerry</b>
                      <span class="badge badge-danger">187</span>
                    </p>
      ...
      <!-- <footer class="footer">
        <div class="w-100 clearfix">
          <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">
            Copyright © 2019
            <a href="http://www.urbanui.com/" target="_blank">Moklet</a>. All rights reserved.
          </span>
